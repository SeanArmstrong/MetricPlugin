...
public class HTTPConnection {
	...
	private final String EEMAIL = "sw.armstrong@ntlworld.com";
	private final String PPASSWORD = "password";
 
	public boolean checkUser(String email, String password) throws Exception{
		String url = METRIC_URL + VERSION + "/users?email="+EEMAIL+";password="+PPASSWORD;
	...
	public String getProjectByName(String name, String email, String password) throws Exception{
		String url = METRIC_URL + VERSION + "/getprojectbyname?email=sw.armstrong@ntlworld.com;password=password;name=Project1";
		String result = sendGet(url);
		return result;
	}

	public String getProjectGuid(String name, String email, String password) throws Exception{
		String url = METRIC_URL + VERSION + "/getprojectguid?email=sw.armstrong@ntlworld.com;password=password;name=Project1";
		return sendGet(url);
	}	
	...
	public void createProject(String name, String email, String password) throws Exception{
		...
		String urlParameters = "email="+EEMAIL+";password="+PPASSWORD+";name="+name;
	...
	public String getKlassId(String methodName, String GUID, String email, String password) throws Exception{
		String url = METRIC_URL + VERSION + "/klasses?email=sw.armstrong@ntlworld.com;password=password;project_guid="+ GUID + ";name=" + methodName;
		...
		if(checkUser(email, password)){
			...
			for(ClassInfo klass : klasses){
				...
				String urlParameters = "email=" + email + ";password=" + password + ";project_guid="+ GUID +
										...
										";depth_of_inheritance=" + klass.depthOfInheritance + ";lcom=" + klass.LCOM + ";cbo=" + klass.CBO;						
				...
				for(MethodInfo m : klass.methods){
					...
					urlParameters = "email=" + email + ";password=" + password + ";project_guid="+ GUID +
									";name=" + m.name + ";klass_id=" + getKlassId(klass.name, GUID, "", "") + 
